...
- `theory/NN-<chapter>.md` — Part III: what design is, structure vs. behavior, the economics (time value, options, cash flows), reversibility, coupling, Constantine's Equivalence, coupling vs. decoupling, cohesion, and the Conclusion. Each ends with a short "Para el tidier" block: the decision rule the chapter gives you.
