...
*(Figura 16-1: Undifferentiated mass of changes)*
...
*(Figura 16-2: Behavior changes and structure changes)*
...
*(Figura 16-3: Behavior and structure changes in sequence)*
...
*(Figura 16-4: Behavior and structure changes in separate PRs)*
